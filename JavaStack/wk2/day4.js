...
function isStackSorted(stack) {
    ...
    while(!stack.isEmpty()){
        ...
        if (tempStack.isEmpty || tempStack.peek().data <= stack.peek().data){
...
thisStack.push(new Node(9)); 
thisStack.push(new Node(8)); 
thisStack.push(new Node(7)); 
thisStack.push(new Node(6)); 
thisStack.push(new Node(5)); 

console.log(thisStack.isEmpty()); 

console.log(countStack(thisStack)); 
console.log(isStackSorted(thisStack)); 

var anotherStack = new slStack(); 

anotherStack.push(new Node(7)); 
anotherStack.push(new Node(10)); 
anotherStack.push(new Node(2)); 
anotherStack.push(new Node(20)); 


console.log(isStackSorted(anotherStack)); 
